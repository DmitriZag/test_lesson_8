...
public class RegistrationPage {
    ...
    CheckResultsComponent resultTableComponent = new CheckResultsComponent();
    ...
    public RegistrationPage checkResult(String field, String value) {
        resultTableComponent.checkResult(field, value);
    ...
    public RegistrationPage registrationFailCheck() {
        modalPage.shouldBe(hidden);
